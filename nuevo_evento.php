...
<html>
	...
	<body data-active="<?= $title; ?>">
		...
		<div class="container">
			...
			<div class="row">
				<h1 class="center-text">Nuevo Evento</h1>
			</div>
			<br />
			<div class="row well">
				<form action="crear_nuevo_evento.php" method="POST" role="form">
						...
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
							<div class="form-group">
								<div class="input-group">
									...
									<input type="tel" class="form-control" name="numcolor" id="numcolor" placeholder="Numero de Colores" required>
								</div>
							</div>
							<?php display_selcolores(); ?>
						</div>				
					</div>
					<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
						<div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 col-sm-offset-2 col-md-offset-2 col-lg-offset-2">
							<div class="form-group">
								<div class="input-group">
									<span class="input-group-addon">#</span>
									<input type="tel" class="form-control" name="numedificio" id="numedificio" placeholder="Numero de Edificios" required>
								</div>
							</div>
							<?php display_seledificios(); ?>
						</div>	
